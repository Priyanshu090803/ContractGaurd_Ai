...
const Hero = () => {
  return (
   ...
   <div className=" p-3 rounded-full bg-radial from-[#bccdf4d0] to-60%  w-1/3 space-y-4    -translate-y-1/2 text-center  ">
     <h1 className=' text-6xl font-bold text-transparent bg-clip-text bg-radial from-[#2d65ff] to-[#58678e]'> ContractGuard <span className=" text-black text-5xl -mx-1">AI</span>  </h1>
  ...
  <BackgroundRippleEffect />
   ...
   <div className=" -mt-16 flex flex-col text-center w-1/2">
    ...
    <div className=" mt-10 space-x-3">
         <Button size={"lg"} className=" cursor-pointer font-medium  text-xl  shadow-md rounded-lg shadow-[#c2c9f1] bg-gradient-to-t  to-[#e3eeee] from-[#e7f7ff] translate-y-0 hover:-translate-y-0.5 hover:shadow-lg text-neutral-800">Get Started</Button>
